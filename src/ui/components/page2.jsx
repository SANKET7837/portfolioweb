	...
	return (
		<section className="relative text-center py-8 md:py-16 bg-slate-100 flex flex-row-reverse items-center">
			...
			<div className="p-4md:p-44 bg-gray-100 text-left">
				<h1 className="text-xl md:text-7xl text-black  font-bold m- p-12">
					I love being a developer !
				</h1>
				<p className="text-sm md:text-3xl m-4 text-pink-600  ">
					Hello, I am murli; The 26 -year-old is a backend developer. I started
					programming in 2010 and continued to specialize in 2015. These days,
					along with programming, I study about startups and businesses, and
					besides all this, I play the dulcimer and watch my favorite series. am
					working
				</p>
